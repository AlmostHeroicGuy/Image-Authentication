...
from simclr_baseline.dataset import build_dataset
from simclr_baseline.trainer import BaselineTrainer


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the standard SimCLR baseline.")
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("runs/simclr_baseline"))
...
def main() -> None:
    ...
    trainer = BaselineTrainer(model, optimizer, scheduler, dataloader, config, device)
    try:
        trainer.train()
    finally:
        cleanup_distributed()
